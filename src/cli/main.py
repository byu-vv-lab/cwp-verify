...
# @impure_safe
# def _get_state(env: str) -> list[str]:
#     return Failure.fromValue

# @impure_safe
# def _get_cwp(env: _VerifyArgs) -> _VerifyArgs:
#     return env

# @safe
# def _validate_cwp(env: _VerifyArgs) -> _VerifyArgs:
#     return env

# @impure_safe
# def _get_bpmn(env: _VerifyArgs) -> _VerifyArgs:
#     return env

# @safe
# def _validate_bpmn(env: _VerifyArgs) -> _VerifyArgs:
#     return env
